 ...
 * - Sirve página HTML con botones para saludar y generar carga de CPU.
 * - Proxy hacia el backend para evitar CORS.
 * - Expone métricas Prometheus y emite logs JSON a stdout → Alloy → Loki.
 */
